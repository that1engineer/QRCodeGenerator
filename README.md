## Follow these 3 steps to begin making your very own QR codes:
...
*(Note for running this in Visual Studio or VS Code: Be sure to open the folder the script is in, or it will not be able to access the QRCodeGenerator script or images you select.)*
